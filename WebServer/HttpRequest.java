...
*/
    private void processRequest() throws Exception {
        ...
        String method = stk.nextToken(); // Mission 2-A: Get method information, Optional Exercises
        String fileName = stk.nextToken(); // Mission 2-B: Get URI information 
        String version = stk.nextToken(); // Mission 2-C: Get HTTP Version information
